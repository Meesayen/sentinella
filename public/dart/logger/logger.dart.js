...
$$.Logger = {"":
 ["toggle", "hide?", "show", "clear", "_timer=", "_visible=", "_node?", "_write", "name?"],
 super: "Object",
 _screenWrite$1: function(msg) {
  var div = $._Elements_DivElement();
  div.set$innerHTML(msg);
  var t1 = this._node;
  t1.insertBefore$2(div, t1.get$nodes().get$first());
  $.gtB($.get$length(t1.get$nodes()), 20) && $.last(t1.get$nodes()).remove$0();
  this.show$0();
 },
 get$_screenWrite: function() { return new $.BoundClosure0(this, '_screenWrite$1'); },
 _alertWrite$1: function(msg) {
  $.window().alert$1(msg);
 },
 get$_alertWrite: function() { return new $.BoundClosure0(this, '_alertWrite$1'); },
 _consoleWrite$1: function(msg) {
  $.window().get$console().log$1(msg);
 },
 get$_consoleWrite: function() { return new $.BoundClosure0(this, '_consoleWrite$1'); },
 _xhrWrite$2: function(msg, type) {
  var time = $.DateImplementation$now();
  var xhr = $._XMLHttpRequestFactoryProvider_XMLHttpRequest();
  var params = $.JSON_stringify($.makeLiteralMap(['app', this.name, 'msg', '[' + $.S(time) + '] ' + $.S(msg), 'type', type, 'user', $.CTC3.get$user()]));
  xhr.open$3('POST', $.CTC3.get$url(), true);
  xhr.setRequestHeader$2('Content-Type', 'application/json');
  xhr.send$1(params);
 },
 get$_xhrWrite: function() { return new $.BoundClosure1(this, '_xhrWrite$2'); },
 info$1: function(msg) {
  this._write$2('[INFO] ' + $.S(msg), 'info');
 },
 log$1: function(msg) {
  this.info$1(msg);
 },
 hide$0: function() { return this.hide.$call$0(); },
 show$0: function() { return this.show.$call$0(); },
 show$0: function() { return this.show.$call$0(); },
 clear$0: function() { return this.clear.$call$0(); },
 _write$2: function(arg0, arg1) { return this._write.$call$2(arg0, arg1); },
 Logger$_internal$1: function(name$) {
  this.clear = new $.anon();
  this.show = new $.anon0();
  this.hide = new $.anon1();
  this.toggle = new $.anon2();
  if ($.eqB($.CTC3.get$xhr(), true)) this._write = this.get$_xhrWrite();
  else {
    if (!($.window().get$console() == null)) this._write = this.get$_consoleWrite();
    else {
      if (!($.window().get$alert() == null)) this._write = this.get$_alertWrite();
      else {
        this._node = $.query('#logger');
        if (this._node == null) this._write = new $.anon3();
        else {
          this._visible = false;
          this._timer = null;
          this._write = this.get$_screenWrite();
          this.clear = new $.anon4(this);
          this.show = new $.anon5(this);
          this.hide = new $.$$function(this);
          this.toggle = new $.$$function0(this);
        }
      }
    }
  }
...
$$.anon4 = {"":
 ...
 super: "Closure",
 $call$0: function() {
  this.this_0.get$_node().set$innerHTML('');
 }
};
...
$$.anon5 = {"":
 ...
 super: "Closure",
 $call$0: function() {
  this.this_1.set$_visible(true);
  $.add$1(this.this_1.get$_node().get$classes(), 'visible');
  this.this_1.get$_timer() === true && $.window().clearTimeout$1(this.this_1.get$_timer());
  var t1 = $.window().setTimeout$2(this.this_1.get$hide(), 15000);
  this.this_1.set$_timer(t1);
 }
};
...
$$.$$function = {"":
 ...
 super: "Closure",
 $call$0: function() {
  this.this_2.set$_visible(false);
  this.this_2.get$_node().get$classes().remove$1('visible');
 }
};
...
$$.$$function0 = {"":
 ...
 super: "Closure",
 $call$0: function() {
  if (this.this_3.get$_visible() === true) {
    this.this_3.get$_timer() === true && $.window().clearTimeout$1(this.this_3.get$_timer());
    this.this_3.hide$0();
  } else this.this_3.show$0();
 }
};
...
$.Logger_Logger = function(name$) {
  if ($.Logger__instances == null) $.Logger__instances = $.makeLiteralMap([]);
  if ($.Logger__instances.containsKey$1(name$) === true) return $.index($.Logger__instances, name$);
  var logger = $.Logger$_internal(name$);
  $.indexSet($.Logger__instances, name$, logger);
  return logger;
};
...
$.Logger$_internal = function(name$) {
  var t1 = new $.Logger(null, null, null, null, null, null, null, null, name$);
  t1.Logger$_internal$1(name$);
  return t1;
};
...
$.CTC11 = new Isolate.$isolateProperties.ConstantMap(Isolate.$isolateProperties.CTC, {}, 0);
$.CTC2 = Isolate.makeConstantList(['xhr', 'user', 'url']);
$.CTC3 = new Isolate.$isolateProperties.ConstantMap(Isolate.$isolateProperties.CTC2, {'xhr': true, 'user': 'meesayen', 'url': 'http://192.168.5.166:3000/log'}, 3);
...
$.$defineNativeClass('DOMWindow', ["navigator?", "name?", "length?", "console?"], {
 ...
 get$alert: function() { return new $.BoundClosure0(this, 'alert$1'); },
